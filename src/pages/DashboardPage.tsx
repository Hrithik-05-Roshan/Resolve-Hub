  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 shadow-md">
          <span className="text-[11px] font-bold uppercase tracking-wider text-emerald-400 block flex items-center gap-1">
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 shadow-md">
          <span className="text-[11px] font-bold uppercase tracking-wider text-indigo-400 block flex items-center gap-1">
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 shadow-md">
          <span className="text-[11px] font-bold uppercase tracking-wider text-amber-400 block flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* AI Insights Widget */}
          <div className="bg-gradient-to-br from-indigo-950/50 via-slate-900 to-violet-950/40 border border-indigo-500/30 rounded-3xl p-6 shadow-xl space-y-4 text-xs">
            <div className="flex items-center justify-between">
              ...
              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold bg-emerald-950/80 text-emerald-300 border border-emerald-700/60 shadow-sm shadow-emerald-950/50">
                99.2% Accuracy
              </span>
            </div>

            <p className="text-slate-300 leading-relaxed font-medium">
              You recovered <strong className="text-emerald-400 font-mono font-bold text-sm">₹4,280</strong> through automatic resolutions this month across 4 connected platforms.
            </p>
            ...
            <div className="space-y-2.5 pt-3 border-t border-slate-800">
              ...
              <div className="flex justify-between text-slate-400">
                ...
                <span className="font-mono font-bold text-indigo-400">42 seconds</span>
              </div>
              <div className="flex justify-between text-slate-400">
              ...
              <div className="flex justify-between text-slate-400">
                ...
                <span className="font-mono font-bold text-emerald-400">88.5%</span>
              </div>
            </div>
            ...
            <div className="pt-3 space-y-2.5 border-t border-slate-800">
              ...
              <div>
                <div className="flex justify-between text-[11px] text-slate-400 font-medium mb-1">
                  ...
                  <span className="font-mono font-bold text-indigo-300">34%</span>
                </div>
                <div className="w-full bg-slate-950 rounded-full h-1.5 overflow-hidden border border-slate-800/60">
                  <div className="bg-gradient-to-r from-indigo-500 to-indigo-400 h-full rounded-full" style={{ width: '34%' }} />
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between text-[11px] text-slate-400 font-medium mb-1">
                  ...
                  <span className="font-mono font-bold text-purple-300">26%</span>
                </div>
                <div className="w-full bg-slate-950 rounded-full h-1.5 overflow-hidden border border-slate-800/60">
                  <div className="bg-gradient-to-r from-violet-500 to-indigo-400 h-full rounded-full" style={{ width: '26%' }} />
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between text-[11px] text-slate-400 font-medium mb-1">
                  ...
                  <span className="font-mono font-bold text-pink-300">18%</span>
                </div>
                <div className="w-full bg-slate-950 rounded-full h-1.5 overflow-hidden border border-slate-800/60">
